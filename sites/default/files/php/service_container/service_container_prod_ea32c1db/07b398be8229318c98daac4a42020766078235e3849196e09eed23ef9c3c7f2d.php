...
class service_container_prod_ea32c1db extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'drupal.proxy_original_service.language_converter' => 'getDrupal_ProxyOriginalService_LanguageConverterService',
            ...
            'language_converter' => 'getLanguageConverterService',
            ...
            'locale.config_manager' => 'getLocale_ConfigManagerService',
            'locale.config_subscriber' => 'getLocale_ConfigSubscriberService',
            'locale.locale_translation_cache_tag' => 'getLocale_LocaleTranslationCacheTagService',
            'locale.project' => 'getLocale_ProjectService',
            ...
            'stream_wrapper.translations' => 'getStreamWrapper_TranslationsService',
    ...
    /**
     * Gets the 'drupal.proxy_original_service.language_converter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\language\LanguageConverter A Drupal\language\LanguageConverter instance.
     */
    protected function getDrupal_ProxyOriginalService_LanguageConverterService()
    {
        $this->services['drupal.proxy_original_service.language_converter'] = $instance = new \Drupal\language\LanguageConverter($this->get('language_manager'));

        $instance->_serviceId = 'drupal.proxy_original_service.language_converter';
    ...
    protected function getLanguage_ConfigFactoryOverrideService()
    {
        ...
        $instance->_serviceId = 'language.config_factory_override';
    ...
    {
        $this->services['language.config_subscriber'] = $instance = new \Drupal\language\EventSubscriber\ConfigSubscriber($this->get('language_manager'), $this->get('language.default'), $this->get('config.factory'));

        $instance->_serviceId = 'language.config_subscriber';
    ...
    {
        $this->services['language.default'] = $instance = new \Drupal\Core\Language\LanguageDefault(array('uuid' => 'a753f406-c298-4855-833e-62a4aeb283ab', 'langcode' => 'nl', 'status' => true, 'dependencies' => array(), 'id' => 'nl', 'label' => 'Dutch', 'direction' => 'ltr', 'weight' => 0, 'locked' => false));
    ...
    /**
     * Gets the 'language_converter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\language\ProxyClass\LanguageConverter A Drupal\language\ProxyClass\LanguageConverter instance.
     */
    protected function getLanguageConverterService()
    {
        $this->services['language_converter'] = $instance = new \Drupal\language\ProxyClass\LanguageConverter($this, 'drupal.proxy_original_service.language_converter');

        $instance->_serviceId = 'language_converter';
    ...
    {
        $this->services['language_manager'] = $instance = new \Drupal\language\ConfigurableLanguageManager($this->get('language.default'), $this->get('config.factory'), $this->get('module_handler'), $this->get('language.config_factory_override'), $this->get('request_stack'));
    ...
    {
        $this->services['language_negotiator'] = $instance = new \Drupal\language\LanguageNegotiator($this->get('language_manager'), $this->get('plugin.manager.language_negotiation_method'), $this->get('config.factory'), $this->get('settings'), $this->get('request_stack'));

        $instance->initLanguageManager();
        $instance->_serviceId = 'language_negotiator';
    ...
    /**
     * Gets the 'locale.config_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getLocale_ConfigManagerService()
    {
        $a = $this->get('config.storage');
        $b = $this->get('language_manager');

        $this->services['locale.config_manager'] = $instance = new \Drupal\locale\LocaleConfigManager($a, $this->get('locale.storage'), $this->get('config.factory'), $this->get('config.typed'), $b, new \Drupal\locale\LocaleDefaultConfigStorage($a, $b));

        $instance->_serviceId = 'locale.config_manager';

        return $instance;
    }

    /**
     * Gets the 'locale.config_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\locale\LocaleConfigSubscriber A Drupal\locale\LocaleConfigSubscriber instance.
     */
    protected function getLocale_ConfigSubscriberService()
    {
        $this->services['locale.config_subscriber'] = $instance = new \Drupal\locale\LocaleConfigSubscriber($this->get('config.factory'), $this->get('locale.config_manager'));

        $instance->_serviceId = 'locale.config_subscriber';

        return $instance;
    }

    /**
     * Gets the 'locale.locale_translation_cache_tag' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\locale\EventSubscriber\LocaleTranslationCacheTag A Drupal\locale\EventSubscriber\LocaleTranslationCacheTag instance.
     */
    protected function getLocale_LocaleTranslationCacheTagService()
    {
        $this->services['locale.locale_translation_cache_tag'] = $instance = new \Drupal\locale\EventSubscriber\LocaleTranslationCacheTag($this->get('cache_tags.invalidator'));

        $instance->_serviceId = 'locale.locale_translation_cache_tag';

        return $instance;
    }

    /**
     * Gets the 'locale.project' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\locale\LocaleProjectStorage A Drupal\locale\LocaleProjectStorage instance.
     */
    protected function getLocale_ProjectService()
    {
        $this->services['locale.project'] = $instance = new \Drupal\locale\LocaleProjectStorage($this->get('keyvalue'));

        $instance->_serviceId = 'locale.project';
    ...
    {
        $this->services['locale.storage'] = $instance = new \Drupal\locale\StringDatabaseStorage($this->get('database'));

        $instance->_serviceId = 'locale.storage';
    ...
    {
        $this->services['module_handler'] = $instance = new \Drupal\Core\Extension\ModuleHandler($this->get('app.root'), array('block' => array('type' => 'module', 'pathname' => 'core/modules/block/block.info.yml', 'filename' => 'block.module'), 'block_content' => array('type' => 'module', 'pathname' => 'core/modules/block_content/block_content.info.yml', 'filename' => 'block_content.module'), 'breakpoint' => array('type' => 'module', 'pathname' => 'core/modules/breakpoint/breakpoint.info.yml', 'filename' => 'breakpoint.module'), 'color' => array('type' => 'module', 'pathname' => 'core/modules/color/color.info.yml', 'filename' => 'color.module'), 'dblog' => array('type' => 'module', 'pathname' => 'core/modules/dblog/dblog.info.yml', 'filename' => 'dblog.module'), 'entity_reference' => array('type' => 'module', 'pathname' => 'core/modules/entity_reference/entity_reference.info.yml', 'filename' => 'entity_reference.module'), 'field' => array('type' => 'module', 'pathname' => 'core/modules/field/field.info.yml', 'filename' => 'field.module'), 'field_ui' => array('type' => 'module', 'pathname' => 'core/modules/field_ui/field_ui.info.yml', 'filename' => 'field_ui.module'), 'file' => array('type' => 'module', 'pathname' => 'core/modules/file/file.info.yml', 'filename' => 'file.module'), 'filter' => array('type' => 'module', 'pathname' => 'core/modules/filter/filter.info.yml', 'filename' => 'filter.module'), 'language' => array('type' => 'module', 'pathname' => 'core/modules/language/language.info.yml', 'filename' => 'language.module'), 'link' => array('type' => 'module', 'pathname' => 'core/modules/link/link.info.yml', 'filename' => 'link.module'), 'locale' => array('type' => 'module', 'pathname' => 'core/modules/locale/locale.info.yml', 'filename' => 'locale.module'), 'menu_link_content' => array('type' => 'module', 'pathname' => 'core/modules/menu_link_content/menu_link_content.info.yml', 'filename' => 'menu_link_content.module'), 'menu_ui' => array('type' => 'module', 'pathname' => 'core/modules/menu_ui/menu_ui.info.yml', 'filename' => 'menu_ui.module'), 'node' => array('type' => 'module', 'pathname' => 'core/modules/node/node.info.yml', 'filename' => 'node.module'), 'page_cache' => array('type' => 'module', 'pathname' => 'core/modules/page_cache/page_cache.info.yml', 'filename' => 'page_cache.module'), 'path' => array('type' => 'module', 'pathname' => 'core/modules/path/path.info.yml', 'filename' => 'path.module'), 'system' => array('type' => 'module', 'pathname' => 'core/modules/system/system.info.yml', 'filename' => 'system.module'), 'text' => array('type' => 'module', 'pathname' => 'core/modules/text/text.info.yml', 'filename' => 'text.module'), 'toolbar' => array('type' => 'module', 'pathname' => 'core/modules/toolbar/toolbar.info.yml', 'filename' => 'toolbar.module'), 'tour' => array('type' => 'module', 'pathname' => 'core/modules/tour/tour.info.yml', 'filename' => 'tour.module'), 'user' => array('type' => 'module', 'pathname' => 'core/modules/user/user.info.yml', 'filename' => 'user.module'), 'views' => array('type' => 'module', 'pathname' => 'core/modules/views/views.info.yml', 'filename' => 'views.module'), 'minimal' => array('type' => 'profile', 'pathname' => 'core/profiles/minimal/minimal.info.yml', 'filename' => NULL)), $this->get('cache.bootstrap'));
    ...
    protected function getParamconverterManagerService()
    {
        ...
        $instance->addConverter($this->get('drupal.proxy_original_service.language_converter'), 'drupal.proxy_original_service.language_converter');
    ...
    {
        $this->services['plugin.manager.language_negotiation_method'] = $instance = new \Drupal\language\LanguageNegotiationMethodManager($this->get('container.namespaces'), $this->get('cache.discovery'), $this->get('module_handler'));

        $instance->_serviceId = 'plugin.manager.language_negotiation_method';
    ...
    /**
     * Gets the 'stream_wrapper.translations' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\locale\StreamWrapper\TranslationsStream A Drupal\locale\StreamWrapper\TranslationsStream instance.
     */
    protected function getStreamWrapper_TranslationsService()
    {
        $this->services['stream_wrapper.translations'] = $instance = new \Drupal\locale\StreamWrapper\TranslationsStream();

        $instance->_serviceId = 'stream_wrapper.translations';
    ...
    protected function getStreamWrapperManagerService()
    {
        ...
        $instance->addStreamWrapper('stream_wrapper.translations', 'Drupal\\locale\\StreamWrapper\\TranslationsStream', 'translations');
    ...
    {
        $this->services['string_translator.locale.lookup'] = $instance = new \Drupal\locale\LocaleTranslation($this->get('locale.storage'), $this->get('cache.default'), $this->get('lock'), $this->get('config.factory'), $this->get('language_manager'), $this->get('request_stack'));

        $instance->_serviceId = 'string_translator.locale.lookup';
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'language.default_values' => array(
                'uuid' => 'a753f406-c298-4855-833e-62a4aeb283ab',
                'langcode' => 'nl',
                'status' => true,
                'dependencies' => array(
