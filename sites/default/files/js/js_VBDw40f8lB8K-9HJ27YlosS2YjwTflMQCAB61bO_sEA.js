...
window.drupalTranslations = {"strings":{"":{"Changed":"Gewijzigd","An AJAX HTTP error occurred.":"Er is een AJAX HTTP fout opgetreden.","An AJAX HTTP request terminated abnormally.":"Een AJAX HTTP-aanvraag is onverwacht afgebroken","Debugging information follows.":"Debug informatie volgt.","Path: !uri":"Pad: !uri","StatusText: !statusText":"Statustekst: !statusText","ResponseText: !responseText":"Antwoordtekst: !responseText","ReadyState: !readyState":"ReadyState: !readyState","Please wait...":"Even geduld...","Home":"Home","closed":"gesloten","Edit":"Bewerken","Show":"Weergeven","Extend":"Uitbreiding","Not published":"Niet gepubliceerd","Hide":"Verbergen","@label":"@label","Drag to re-order":"Slepen om de volgorde te wijzigen","Requires a title":"Een titel is verplicht","Not restricted":"Geen beperking","(active tab)":"(actieve tabblad)","Restricted to certain pages":"Beperkt tot bepaalde pagina\u0027s","The block cannot be placed in this region.":"Het blok kan niet worden geplaatst in dit gebied.","Don\u0027t display post information":"Geen berichtinformatie weergeven","Collapse":"Inklappen","Re-order rows by numerical weight instead of dragging.":"Herschik de rijen op basis van gewicht, in plaats van slepen.","Show row weights":"Gewicht van rijen tonen","Hide row weights":"Gewicht van rij verbergen","Show all columns":"Alle kolommen tonen","Show table cells that were hidden to make the table fit within a small screen.":"Toon de tabelcellen die verborgen werden om de tabel te laten passen op een klein scherm.","List additional actions":"Aanvullende acties weergeven","opened":"geopend","Horizontal orientation":"Horizontale ori\u00ebntatie","Vertical orientation":"Verticale ori\u00ebntatie","You have unsaved changes.":"De wijzigingen zijn niet opgeslagen.","!tour_item of !total":"!tour_item van !total","Hide lower priority columns":"Kolommen met een lagere prioriteit verbergen"}},"pluralFormula":{"1":0,"default":1}};;
/**
 * @file
